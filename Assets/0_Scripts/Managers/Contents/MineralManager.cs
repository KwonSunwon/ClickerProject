...
public class MineralManager : ISaveHandler
{
    ...
    public void Init()
    {
        ...
        var slots = new List<MineralSlot>
            {
                new MineralSlot((MineralType)0, new BigNumber(200), new BigNumber(000000000)),
                new MineralSlot((MineralType)1, new BigNumber(100), new BigNumber(00000000)),
                new MineralSlot((MineralType)2, new BigNumber(300), new BigNumber(0000000)),
                new MineralSlot((MineralType)3, new BigNumber(300), new BigNumber(000000)),
                new MineralSlot((MineralType)4, new BigNumber(300), new BigNumber(00000)),
                new MineralSlot((MineralType)5, new BigNumber(300), new BigNumber(0000)),
                new MineralSlot((MineralType)6, new BigNumber(300), new BigNumber(000)),
                new MineralSlot((MineralType)7, new BigNumber(300), new BigNumber(000)),
                new MineralSlot((MineralType)8, new BigNumber(300), new BigNumber(000)),
                new MineralSlot((MineralType)9, new BigNumber(300), new BigNumber(000)),
                new MineralSlot((MineralType)10, new BigNumber(300), new BigNumber(00)),
                new MineralSlot((MineralType)11, new BigNumber(300), new BigNumber(00)),
                new MineralSlot((MineralType)12, new BigNumber(300), new BigNumber(00)),
                new MineralSlot((MineralType)13, new BigNumber(300), new BigNumber(0)),
                new MineralSlot((MineralType)14, new BigNumber(300), new BigNumber(0)),
                new MineralSlot((MineralType)15, new BigNumber(300), new BigNumber(0)),
                new MineralSlot((MineralType)16, new BigNumber(300), new BigNumber(0)),
                new MineralSlot((MineralType)17, new BigNumber(300), new BigNumber(0)),
                new MineralSlot((MineralType)18, new BigNumber(300), new BigNumber(0)),
                new MineralSlot((MineralType)19, new BigNumber(300), new BigNumber(0)),
                new MineralSlot((MineralType)20, new BigNumber(300), new BigNumber(0)),
                new MineralSlot((MineralType)21, new BigNumber(300), new BigNumber(0)),
                new MineralSlot((MineralType)22, new BigNumber(300), new BigNumber(0)),
            };
